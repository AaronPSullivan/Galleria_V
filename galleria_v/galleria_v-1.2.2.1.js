/**
 * Galleria_V version 1.2.2.1 2011-05-23 
 * New: padded stage functionality restored 
 *
...
/**
 * @preserve Galleria 1.2.2 2011-02-25
...
var Galleria = function() {
    ...
    var divs =  'container stage images image-nav image-nav-left image-nav-right ' +
                ...
                'thumbnails thumbnails-list thumbnails-container thumb-nav-up thumb-nav-down ' +
    ...
    var carousel = this._carousel = {
        ...
        // shortcuts
        next: self.$('thumb-nav-down'),
        prev: self.$('thumb-nav-up'),
        ...
        // save all hooks for each height in an array
        hooks: [],
...
Galleria.prototype = {
    ...
    */
    ...
    _init: function() {
        ...
        this.append({
            ...
            'thumbnails-container' :
                ['thumb-nav-up', 'thumbnails-list', 'thumb-nav-down'],
            'container' :
        ...
        $.each( ['info','counter','image-nav', 'fullscreen'], function( i, el ) {
    ...
    _createThumbnails : function() {
		...
		// Add the class of 'last' to the last thumbnail. This allows you to remove the margin using CSS
		$( thumb.container ).addClass('last');
