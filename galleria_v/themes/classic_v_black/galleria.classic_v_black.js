/**
 * Galleria_V Classic Black version 1.2.2.1 2011-05-23 
 *
...
Galleria.addTheme({
    name: 'classic_v_black', /* hacked version of the classic theme that has a vertical carousel and a fullscreen button */
    author: 'Galleria',
    css: 'galleria.classic_v_black.css',
    defaults: {
        transition: 'slide',
        thumbCrop:  'height',
		showFullscreen: true,
		showInfo: true,
		thumbNavArea: 39, /* pixel amount to offset the height of thumbnail-list to create the illusion of a margin at the top and bottom. This margin allows for the thumbnavs to appear above and below the thumbnails */
		padArea: 20, /* pixel amount that the stage is offset in CSS... this amount is added to thumbNavArea so Galleria_v knows the correct height of thumbnail-list if padding is used. */ 
